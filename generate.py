...
@media (max-width:768px) {
  ...
  .nav-overlay a { display:block; padding:16px 0; font-size:18px; font-weight:700; color:var(--heading); text-decoration:none; border-bottom:1px solid var(--border); }
  .nav-overlay a:hover { color:#b8943f; }
  .nav-overlay .donate-btn { margin-top:24px; padding:16px; background:var(--accent); color:var(--card); font-weight:700; font-size:16px; text-align:center; border:2px solid var(--accent); text-decoration:none; border-radius:4px; }
}
